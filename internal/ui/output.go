...
// This is shown at the top of the help output and during init flows.
func PrintBanner(version string) {
	...
	desc := lipgloss.NewStyle().
		...
		Italic(true).
		Render("Sync secrets from your password manager into your shell environment")
...
// PrintError prints an error message with a red cross prefix.
...
func PrintError(label string, err error) {
	...
	fmt.Fprintf(os.Stderr, "\n %s %s\n   %s\n\n", CrossMark, header, detail)
}

// PrintWarning prints a warning message with an amber exclamation prefix.
...
// Use this for status updates and neutral information.
func PrintInfo(message string) {
	fmt.Printf(" %s %s\n", InfoMark, message)
}

// PrintStep prints a numbered step in a multi-step process.
// Example output: "  1. Unlocking vault..."
...
// The label is rendered in the primary color, and the value in the default color.
// This is useful for diagnostic reports and status displays.
...
// PrintStatusLine prints a single diagnostic status line.
// The "ok" parameter controls whether a green checkmark or red cross is shown.
// This is used in the "bwenv test" output.
...
// PrintWarningLine prints a diagnostic line with a warning indicator.
...
// PrintInfoLine prints a diagnostic line with an info indicator.
...
// PrintSection prints a section header — a bold label with a divider below it.
// Use this to visually separate groups of output lines.
...
// Use this for critical failures that need attention.
...
// SpinnerMessage returns a formatted message suitable for use with a spinner.
// This just applies consistent styling to the text shown next to a loading indicator.
